...
\end{itemize}
	...
	\begin{itemize}
				...
				\end{itemize}
					\item[] \textbf{\code{+ getUserList ( function(userSchema[], String) : callback )}} \\ Metodo che restituisce la lista degli utenti.
						\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
						\item[] \textbf{Parametri:}
						\item[] \code{callback} \\ Questo parametro rappresenta la callback che il metodo dovrà chiamare al termine dell'elaborazione senza errori passandogli la lista di utenti.	
				\end{itemize}
		\end{itemize}
