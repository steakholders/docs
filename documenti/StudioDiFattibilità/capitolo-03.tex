...
\subsection{C5 - SGAD}
        ...
        \begin{itemize}
            ...
            \item \textbf{Test/simulazione:} alla presentazione è stato chiarito l'aspetto di testing del software che si realizzerebbe inizialmente in ambiente LAN per poi spostarsi verso \glossario{AWS} per simulare una situazione di utilizzo reale.
        \end{itemize}
        Il gruppo ritiene che le suddette considerazioni necessitino di troppo tempo in attività di \glossario{autoformazione}, inoltre i test richiederebbero una diretta collaborazione con il proponente \textit{FunGoStudios} e relative trasferte nella sede della suddetta \glossario{startup}.
        %\subsubsection{Potenziali criticità}