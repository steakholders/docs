...
\definizione{Task}
Un task è un'unità di lavoro pianificata e assegnata. Un task può essere associato ad uno o più \glossario{ticket}, a seconda del carico di lavoro che essi richiedono.
...
\definizione{Ticket}
Con il termine ticket si intende un'unità di lavoro con cui apportare un miglioramento in un sistema. Un ticket può essere un bug, una richiesta di funzionalità, un compito, e così via.
