...
Se la funzione di \glossario{namespace} è abilitata dovrà essere configurato anche il \glossario{namespace} corrispondente. \\ 
          ...
          \textbf{Flusso Principale} & 1. Lo sviluppatore configura la connessione al database delle credenziali. (UCS2.1) \\
           \textbf{Scenari Alternativi} & 1. Lo sviluppatore definisce il namespace da associare al database delle credenziali. \\
      \end{longtable}
      \egroup
\end{center}
...
Se la funzione di \glossario{namespace} è abilitata dovrà essere configurato anche il \glossario{namespace} corrispondente. \\ 
          ...
          \textbf{Flusso Principale} & 1. Lo sviluppatore configura la connessione al database delle \glossario{Collection}. (UCS2.2) \\
           \textbf{Scenari Alternativi} & 2. Lo sviluppatore definisce il namespace per il database delle \glossario{Collection}. \\
      \end{longtable}
      \egroup
\end{center}
