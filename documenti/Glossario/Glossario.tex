...
\definizione{MVC}
\glossario{Design Pattern} architetturale che divide l'applicazione in tre parti interconnesse, separando l'interfaccia utente, la logica e i dati.
...
\definizione{REST}
Acronimo di Representational State Transfer è un tipo di \glossario{RPC}. Si basa su un protocollo di comunicazione \glossario{stateless} di tipo client-server, e solitamente tale protocollo è \glossario{HTTP}.
