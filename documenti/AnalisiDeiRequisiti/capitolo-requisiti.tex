...
%Tabella 
      ...
      \cellcolor[gray]{0.9} \textbf{Fonti} & \cellcolor[gray]{0.9} \textbf{Requisiti} \\ \hline       
            ...
            UCU 4 - Recupero password &  RA1O 2.3 \newline  RA1O 2.2 \newline  RA1O 2.1 \newline  RA1O 2 \newline  \\ \hline      
...
\subsection{Tracciamento Requisiti - Test di Sistema}
 ...
 & TS-RA1O 1.3.2 & \\ \hline 
        ...
        RA1O 2.3 & 
        L'applicazione \glossario{MaaP} deve permettere il reset della password ad un utente non autenticato inserendone una nuova che sostituirà la precedente come password di accesso all'applicazione. & TS-RA1O 2.3 & \\ \hline 
        RA1D 3 & 
 ...
 & TS-RA1O 6.2.4 & \\ \hline 
        ...
        RF1O 7 & 
        MaaP Framework deve rendere disponibile allo sviluppatore un linguaggio astratto DSL di tipo testuale necessario per la generazione delle pagine. &  &  \\ \hline 
        RF1O 8 & 
        Maap Framework deve permettere allo sviluppatore di generare un nuovo progetto tramite linea di comando. &  &  \\ \hline 
        RF1O 8.1  & 
        ...
        RS1F 10 & 
        Il sistema MaaS deve mettere a disposizione il framework MaaP come servizio web. &  &  \\ \hline 
        RS1F 10.1 & 
        ...
        RS1F 10.5 & 
        Il servizio MaaS deve visualizzare un messaggio d’errore nel caso in cui la registrazione fallisca a causa di credenziali già esistenti. &  &  \\ \hline 
        RS1F 10.6 & 
        ...
        RA1D 11 & 
        Deve essere possibile da parte di un utente la registrazione all’Applicazione MaaP. &  &  \\ \hline 
        RA1D 12 & 
        ...
        RF1O 14 & 
        Il framework MaaP deve rendere possibile la configurazione dei database di cui dispone. &  &  \\ \hline 
        RF1O 14.1 & 
        ...
        RS1F 17 & 
        Il sistema MaaS deve verificare se i documenti creati rispettano i vincoli del database. &  &  \\ \hline 
        RA1O 18 & 
        Il sistema deve mettere a disposizione un validatore del codice DSL e visualizzare gli eventuali errori logici o di sintassi in un'apposita pagina. &  &  \\ \hline 
        RS1F 19 & 
