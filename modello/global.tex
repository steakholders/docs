...
\newcommand{\Responsabile}{Giacomo Fornari}
...
\newcommand{\VersioneG}{1.3.1}
\newcommand{\VersionePQ}{1.3.1}
\newcommand{\VersioneNP}{1.3.1}
\newcommand{\VersionePP}{1.3.1}
\newcommand{\VersioneAR}{1.3.1}
\newcommand{\VersioneSF}{1.3.1}
% Il vebale non ha versionamento.
