...
Per l'interfaccia della componente Back-end di \ProjectName{} si è scelto di utilizzare uno stile REST-like, ovvero basato sullo stile \glossario{REST} ma modificato quel tanto che basta per permettere l'autenticazione tramite cookie. All'interno di un'unica sessione utente, a partire dall'operazione di login fino a quella di logout, l'interfaccia può considerarsi effettivamente \glossario{REST}.
