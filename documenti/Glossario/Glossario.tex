...
\glossario{Framework} per generare interfacce web di amministrazione dei dati di business basato su stack \glossario{Node.js} e \glossario{MondoDB}.
...
Clone di prova che simula la classe contenente il main. E' complementare allo \glossario{Stub}.
