...
Di questa collection può filtrarne i risultati visualizzabili, può eseguire tramite bottoni predisposti nella pagina azioni personallizzati e per ogni \glossario{Document}, selezionarlo e visualizzarne la show-page corrispondente.  \newline
...
2. L'utente autenticato può aprire l'ndex-page dell'array di \glossario{Document} (UCU9.1.2);  \newline
