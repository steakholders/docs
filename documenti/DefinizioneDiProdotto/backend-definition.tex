...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\bullet$] \class{Back-end::Lib::Controller::Service::ControllerFactory}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\bullet$] \class{Back-end::Lib::Controller::Service::ForgotController}
\item[$\bullet$] \class{Back-end::Lib::Controller::Service::ProfileController}
\item[$\bullet$] \class{Back-end::Lib::Controller::Service::UserController}
\item[$\bullet$] \class{Back-end::Lib::Controller::Service::ShowController}
\item[$\bullet$] \class{Back-end::Lib::Controller::Service::IndexController}
\end{itemize}
\end{itemize}
