\section{Introduzione}
	...
	La segnalazione di problemi e malfunzionamenti avviene creando una \glossario{issue} di \glossario{GitHub} tramite l'apposito pulsante collocato nel \glossario{footer} di ogni pagina. L'oggetto della \glossario{issue} dovrà essere conciso e descrittivo del problema riscontrato. La descrizione del problema dovrà contenere i seguenti punti:
