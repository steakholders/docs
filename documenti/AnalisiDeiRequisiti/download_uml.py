...
lucidchart.download_image("4c73-4560-52aaed73-83b3-40820a00d457", "UML/UCU 10 - Modifica profilo.png")
lucidchart.download_image("482c-b2e4-52a73b22-9361-34180a009f85", "UML/UCU 11 - Gestione utenti.png")
lucidchart.download_image("4b7b-431c-52a73bc9-898c-552e0a00c811", "UML/UCU 11.1 - Creazione utente.png")
lucidchart.download_image("478e-3890-52b02514-9bb1-1a050a00c462", "UML/UCU 11.3 - Apertura show-page Utente.png")

lucidchart.download_image("4c0e-8c78-52d3f94e-9c77-118c0a009902", "UML/UCU 4 - Recupero password.png")
lucidchart.download_image("4f18-b848-52d3fefb-a245-23890a00d44d", "UML/UCU 4.1 - Richiesta reset password.png")
lucidchart.download_image("4ad1-71f4-52d408a5-9481-3c2f0a00cb95", "UML/UCU 4.2 - Effettuazione reset password.png")


#UML AMBITO SVILUPPATORE
lucidchart.download_image("47e2-6998-52a85f0a-a1b4-55cd0a00c462", "UML/UCS 0 - Operazioni ad alto livello.png")
lucidchart.download_image("4ddd-fbf0-52a97bae-bbab-32110a009f85", "UML/UCS 2 - Configurazione database.png")
lucidchart.download_image("4df6-7b64-52a86f52-b01c-16320a00c462", "UML/UCS 3 - Gestione Collection.png")
lucidchart.download_image("4af3-92a4-52a882cb-bcad-1aef0a0086f4", "UML/UCS 3.3 - Configurazione Collection.png")
lucidchart.download_image("429b-795c-52a8840b-8a61-2e420a009f85", "UML/UCS 3.3.1 - Personalizzazione index page.png")
lucidchart.download_image("41f9-8f68-52a88caa-9e42-09da0a00c462", "UML/UCS 3.3.2 - Personalizzazione show page.png")
#UML AMBITO MAAS
lucidchart.download_image("4597-26dc-52d44c37-8364-109e0a00cb95", "UML/UCM 0 - Operazioni ad alto livello - Utente MaaS non autenticato.png")
lucidchart.download_image("49ed-78a8-52b1a3c1-8a77-3ddc0a00dea9", "UML/UCM 0 - Operazioni ad alto livello - Utente MaaS autenticato.png")
lucidchart.download_image("43a0-e1c8-52b385b6-ab48-59f90a00dea9", "UML/UCM 1 - Registrazione.png")
lucidchart.download_image("4ab7-1b8c-52b3864d-8eb7-4a7b0a009f85", "UML/UCM 4 - Login.png")
lucidchart.download_image("4608-6404-52b38737-8513-792a0a005e00", "UML/UCM 6 - Modifica profilo.png")
lucidchart.download_image("47d4-44e0-52b1a49b-9b0b-6cf60a0052b1", "UML/UCM 8 - Gestione file di configurazione.png")
