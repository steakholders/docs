...
\\Lo sviluppatore fondamentalmente eseguirà la creazione di un nuovo progetto e di una nuova \textit{Collection\ped{G}} da linea di comando, per poi andare a modificare manualmente i file di configurazione del progetto.
	...
	Lo sviluppatore per utilizzare \ProjectName{} deve aver installato correttamente il framwork, il quale richiede a sua volta l'installazione di tutto lo \textit{stack tecnologico} sui cui esso si basa:
	\begin{itemize}
