...
\begin{figure}[H]
	\begin{center} 
		\includegraphics[scale=0.20]{uml/scenari/Collection Name Document PUT.png} 
...
\begin{figure}[H]
	\begin{center} 
		\includegraphics[scale=0.20]{uml/scenari/Action Name Collection PUT.png} 
...
\begin{figure}[H]
	\begin{center} 
		\includegraphics[scale=0.20]{uml/scenari/Action Name Collection Document PUT.png} 
