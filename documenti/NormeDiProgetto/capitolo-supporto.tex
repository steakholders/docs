...
\begin{itemize}
 \item \textbf{\file{root/lib/}} \\
	Contiene i file della componente Backend del progetto, posizionati in una cartella \code{lib} secondo la convenzione dei moduli di Node.js.
 ...
 \item \textbf{\file{root/lib/controller/controller/}} \\
 ...
 \item \textbf{\file{root/test/}} \\
	Contiene i file relativi ai test d'unità della libreria.
 ...
 \item \textbf{\file{root/scaffold/config}} \\
	Contiene i file di configurazione dell'applicazione scaffold.

 \item \textbf{\file{root/scaffold/config/collections}} \\
	Contiene i file di configurazione delle collection (nel formato dsl) utilizzate dall'applicazione scaffold.

 \item \textbf{\file{root/scaffold/config/env}} \\
	Contiene i file di configurazione dell'ambiente (development o production, di default) dell'applicazione scaffold.

 \item \textbf{\file{root/scaffold/public}} \\
