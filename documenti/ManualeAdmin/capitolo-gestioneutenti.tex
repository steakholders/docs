...
\label{gestioneutenti}
	...
	\label{utenti-eliminazione}
		\begin{enumerate}
				...
				% \item Viene visualizzato un messaggio di conferma di avvenuta creazione utente (Figura \ref{fig:}).

				% 	\begin{figure}[H]
				% 		\centering \includegraphics[width=0.5\textwidth]{img/.png}
				% 		\caption{ \label{fig:} Conferma modifica utente}
				% 	\end{figure}
