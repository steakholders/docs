...
L'utente deve possedere una connsesione ad internet, un web browser (Chrome \geq 30.0.x, Firefox \geq 24.x), una piattaforma che fornisca \glossario{MaaP} come servizio raggiungibile tramite un \texttt{url} e le relative credenziali di accesso.
