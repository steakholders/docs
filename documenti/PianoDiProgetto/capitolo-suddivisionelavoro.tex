...
\toprule 
    ...
    \midrule
		 	...
		 	\input{suddivisione_totale_con_analisi}
...
\begin{tikzpicture}
\begin{axis}
	\input{columnChart_totale_con_analisi}
\legend{amministratore, analista, progettista, programmatore, responsabile, verificatore}
\end{axis}
\end{tikzpicture}
\caption{Ore per componente totali, incluso periodo di Analisi}
...
\toprule
    ...
    \midrule
    	...
    	\input{consuntivo_component_totale_1}
