...
\begin{enumerate}
 	...
 	\item Configurare le collections dell'applicazione, riferendosi alla sezione \ref{collection} di questo manuale. All'interno della cartella \code{collections} sono presenti dei file \code{DSL} di esempio;
