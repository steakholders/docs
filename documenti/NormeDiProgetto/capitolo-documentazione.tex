...
%	\subsubsection{Bozze}
	...
	Un documento viene definito formale quando viene validato dal \textit{Responsabile di Progetto}. Solo i documenti formali possono essere distribuiti all'esterno del gruppo. Per arrivare a tale stato il documento deve aver già passato le fasi di \glossario{verifica} e \glossario{validazione}.
