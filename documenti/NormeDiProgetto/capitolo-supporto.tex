...
\subsection{Processo di Documentazione}
	...
	Lo scopo di questo processo è lo sviluppo e il mantenimento della documentazione prodotta durante il ciclo di vita del software.

	\subsubsection{Risultati osservabili del processo}
	Questo processo produce:
	\begin{itemize}
		\item L'Individuazione della documentazione da produrre durante il ciclo di vita del software;
		\item la selezione degli standard utilizzati per la documentazione;
		\item l'identificazione, verifica e approvazione degli scopi e contenti della documentazione prodotta;
		\item una documentazione aderente agli standard scelti. 
	\end{itemize}
...
Ciascun documento deve rispettare le norme tipografiche definite nella seguente sezione, in modo da rendere il tutto uniforme. Per le situazioni che non sono coperti dalle seguenti norme è preferibile riferirsi a quanto stabilito dall'Accademia della Crusca (\url{http://www.accademiadellacrusca.it}).
	...
	\paragraph{Nomenclatura entità e relazioni}

	I nomi dei package seguono la specifica \emph{upper camel case}. Nel caso un package appartenga ad un altro package, il nome sarà formato da il nome del padre posto in prefisso secondo lo schema \texttt{NomePackagePadre::NomePackageFiglio}. 

	I nomi delle classi devono riportare come prefisso il nome del package di appartenenza separati da una coppia di due punti, seguendo lo schema \texttt{NomePackage::NomeClasse}. I nomi delle classi seguono la specifica \emph{upper camel case}.
	...
	\begin{itemize}
		...
		\item variabili
	\end{itemize}
	seguono la specifica \emph{lower camel case}. 
...
\subsection{Processo di Verifica}
	\subsubsection{Scopo del processo}
	Lo scopo del processo di verifica è quello di confermare che ogni componente software sviluppato rispecchi quanto previsto dai requisiti.
	...
	\begin{itemize}
		...
		\item le attività do verifica sono state svolte;
		\item i difetti sono stati individuati e catalogati;
		\item i risultati della verifica sono resi disponibili agli \glossario{stakeholders}. 
	\end{itemize}
