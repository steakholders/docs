  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib::AuthModel.png}  
...
Il costruttore del modello dello schema dei dati viene registrato nella \glossario{Factory} di \glossario{Mongoose} ed ogni istanza condividerà la stessa connessione al server.
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::DeveloperProject.png}  
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib::MailView.png}  
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib.png}  
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib::Middleware.png}  
  ...
  \subparagraph{Descrizione} 
    ...
    \subparagraph{Package contenuti} 
    \begin{itemize}
        \item Back-end::Lib::Middleware::Errorhandler
    \end{itemize}
    \paragraph{Classi}
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib::DSLModel.png}  
...
Costituisce la componente model dell'architettura MVC del back-end.
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib::Controller.png}  
...
È uno dei componenti product del \glossario{Design Pattern} \glossario{Factory method}.
        ...
        \textbf{Utilizzo}  
          \begin{itemize}
            \item[] Viene utilizzata per gestire la risorsa corrispondente all'index-page di un \glossario{Document}, offrendo metodi per restituendone gli attributi, effettuarne la modifica o la cancellazione e delega la visualizzazione dell'index-page alla classe \texttt{Back-end::Lib::DSLModel::DSLDomain}.
...
È uno dei componenti product del \glossario{Design Pattern} \glossario{Factory method}.
        ...
        \textbf{Utilizzo}  
          ...
          \end{itemize}
  \subsubsection{Back-end::Lib::Middleware::Errorhandler}
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        \includegraphics[scale=1]{packages/Back-end::Lib::Middleware::Errorhandler.png}  
        \caption{Componente Back-end::Lib::Middleware::Errorhandler}
      \end{center}  
    \end{figure} 
  \subparagraph{Descrizione} 
    \begin{itemize}
