...
\begin{tikzpicture}
\begin{axis}
\input{columnChart_consuntivo_rq}
\legend{preventivate,consumate}
\end{axis}
\end{tikzpicture}
\caption{Differenza preventivo consuntivo per ruolo, periodo di progettazione di dettaglio e codifica}
...
\begin{tikzpicture}
\begin{axis}
\input{columnChart_consuntivo_ra}
\legend{preventivate,consumate}
\end{axis}
\end{tikzpicture}
\caption{Differenza preventivo consuntivo per ruolo, periodo di Validazione}
...
\toprule
    ...
    \midrule
    	...
    	\input{consuntivo_roles_totale_1}
...
\begin{tikzpicture}
\begin{axis}
\input{columnChart_consuntivo_totale_1}
\legend{preventivate,consumate}
\end{axis}
\end{tikzpicture}
\caption{Differenza preventivo consuntivo per ruolo, totale corrente}
