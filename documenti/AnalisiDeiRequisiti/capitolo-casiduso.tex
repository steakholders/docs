...
\subsubsection{UCS 3.3  - Configurazione Collection} 
    ...
    \end{figure}  
      ...
      \textbf{Attori Primari} & Sviluppatore \\ 
          \textbf{Scopo e Descrizione} & Lo sviluppatore modifica il file di configurazione di una \glossario{Collection} \\ 
...
\subsubsection{UCS 3.3.1 - Personalizzazione index page} 
    ...
    \end{figure}  
      ...
      \textbf{Attori Primari} & Sviluppatore \\ 
          \textbf{Scopo e Descrizione} & Lo sviluppo sviluppatore personalizza la index-page della \glossario{Collection} selezionata. \\ 
