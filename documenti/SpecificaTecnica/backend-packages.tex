  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        ...
        \caption{Componente Back-end::Lib::View}
      \end{center}  
    \end{figure} 
  \subparagraph{Descrizione} 
    \begin{itemize}
...
password. Verranno utilizzate dal \glossario{middleware} Mailer.
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        ...
        \caption{Componente Back-end::Lib::Model}
      \end{center}  
    \end{figure} 
  \subparagraph{Descrizione} 
    \begin{itemize}
  ...
  \subparagraph{Descrizione} 
    ...
    \subparagraph{Package contenuti} 
    \begin{itemize}
        \item Back-end::Lib::Controller::Middleware
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        ...
        \caption{Componente Back-end::Lib::Controller::Middleware}
      \end{center}  
    \end{figure} 
  \subparagraph{Descrizione} 
    \begin{itemize}
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        ...
        \caption{Componente Back-end::Lib::Controller::Controller}
      \end{center}  
    \end{figure} 
  \subparagraph{Descrizione} 
    \begin{itemize}
  ...
  \paragraph{Informazioni sul package} 
    \begin{figure}[H] 
      \begin{center} 
        ...
        \caption{Componente Back-end::Lib::Model::DSLModel}
      \end{center}  
    \end{figure} 
  \subparagraph{Descrizione} 
    \begin{itemize}
