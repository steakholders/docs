...
\subsection{Report Validazione}
	...
	\subparagraph{\glossario{Stakeholders}}
	Il gruppo è riuscire a giungere alla stadio \emph{Satisfied for Deployment}. Gli \glossario{stakeholders} hanno fornito dei feedback positivi in merito allo stato del sistema e sono soddisfatti per i risultati conseguiti.

	\subparagraph{Requirements}
	Il gruppo è giunto allo stato \emph{Fulfilled}. Tutti i requisiti accettati sono stati sviluppati soddisfacendo i bisogni. Gli \glossario{stakeholders} concordando con la qualità dello sviluppo dei requisiti.

	\subparagraph{Software System}
	Il gruppo è giunto allo stato \emph{Ready}. \`E disponibile documentazione fruibile per tutti i tipi di utenti del sistema. I bug sono stati risolti. Non è ancora dato sapere se gli \glossario{stakeholders} intendono rendere il sistema operativo.
