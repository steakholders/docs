...
A molte delle richieste il server può rispondere con un messaggio di errore nel formato \glossario{JSON}, inviato con un codice \glossario{HTTP} della tipologia 4xx (errore client) o 5xx (errore server). 
...
Vengono di seguito descritte le librerie aggiuntive utilizzate dal Back-end.
