	...
	\paragraph{Informazioni sul package} 
		\begin{figure}[H] 
			\begin{center} 
				\includegraphics[width=0.7\textwidth]{uml/package/Front-end.png}  
	...
	\subparagraph{Descrizione} 
		...
		\paragraph{Classi}
			...
			\subparagraph{LogoutController}
				...
				\textbf{Utilizzo}  
					\begin{itemize}
						\item[] Questo controller si occupa di distruggere la sessione attuale, se esiste, e non genera una view ma reindirizza l'utente automaticamente alla pagina di Login.
					\end{itemize}
