...
L'architettura del progetto si suddivide innanzitutto in una componente Client, costituita dal browser degli utenti che interagiranno con il front-end dell'applicazione, e in un web server, su cui verrà posto il back-end. Il server che ospita i database (la cui configurazione non è compito del progetto) non è necessario che risieda sullo stesso nodo su cui è posto il back-end.
...
\begin{figure}[H] %TODO modificare con il deployment
\centering
