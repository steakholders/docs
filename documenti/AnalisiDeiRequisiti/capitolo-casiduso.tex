...
\subsubsection{UCU 0 - Operazioni ad alto livello - Utente non autenticato}    
    ...
    \end{figure}    
      ...
      \textbf{Attori Primari} & Utente non autenticato \\ 
          ...
          \textbf{Postcondizioni} & L’applicazione ha ricevuto le informazioni sulle operazioni che l’utente non autenticato vuole eseguire. \\ 
...
\subsubsection{UCU 11.2 - Visualizzazione messaggio errore per creazione fallita} 
      %Tabella 
      \begin{center}
      \bgroup
      \def\arraystretch{1.8}     
      ...
      \hline
      \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UCU 11.2 - Visualizzazione messaggio errore per creazione fallita}} \\ 
      \hline
      
      \textbf{Attori Primari} & Admin \\ 
          \textbf{Scopo e Descrizione} & L'Admin ha inserito delle credenziali errate e la creazione di un nuovo utente è fallita, viene quindi visualizzato un messaggio d'errore.
