...
Le funzionalità di gestione delle \glossario{collection} elencate di seguito sono specificate nel \emph{ManualeUtente.pdf}:
	\begin{itemize}
		\item Visualizzazione \glossario{dashboard};
		\item Apertura \glossario{collection index};
		\item Apertura della show-page di un \glossario{document};
	...
	\label{eliminazionedocumentdashowpage}
			...
			Per eliminare un \glossario{document} a partire dalla relativa show-page (Figura \ref{fig:eliminazionedocumentdashowpage}) cliccare il pulsante \emph{Delete Document} (1). Confermare l'eliminazione come indicato in \ref{confermaEliminazDocument}.
