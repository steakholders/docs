...
\subsubsection{UCU - Operazioni ad alto livello - Utente non autenticato}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU - Operazioni ad alto livello - Utente non autenticato.png}
...
\subsubsection{UCU - Operazioni ad alto livello - Utente autenticato}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU - Operazioni ad alto livello - Utente autenticato.png}
...
\subsubsection{UCU4 - Recupero password}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU4 - Recupero password.png}
...
\subsubsection{UCU4.1 - Richiesta reset password}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU4.1 - Richiesta reset password.png}
...
\subsubsection{UCU4.2 - Effettuazione reset password}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU4.2 - Effettuazione reset password.png}
...
\subsubsection{UCU9 - Apertura Collection Index}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU9 - Apertura Collection Index.png}
...
\subsubsection{UCU9.1 - Apertura show-page Document}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU9.1 - Apertura show-page Document.png}
...
\subsubsection{UCU11.3 - Apertura show-page Utente}    
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCU11.3 - Apertura show-page Utente.png}
...
\subsubsection{UCS2.1 - Configurazione database credenziali} 
      ...
      \textbf{Attori Primari} & Sviluppatore \\ 
          \textbf{Scopo e Descrizione} & Lo sviluppatore può configurare la connessione al database delle credenziali degli utenti, i quali utilizzeranno l'applicazione generata dal \glossario{Framework}.
...
\subsubsection{UCS2.2 - Configurazione database Collection} 
      ...
      \textbf{Attori Primari} & Sviluppatore \\ 
          \textbf{Scopo e Descrizione} & Lo sviluppatore può configurare la connessione al database delle \glossario{Collection} che l'applicazione generata dal \glossario{Framework} utilizzerà.
Se la funzione di \glossario{namespace} è abilitata dovrà essere configurato anche il \glossario{namespace} corrispondente. \\ 
...
2. Lo sviluppatore specifica i permessi delle azioni personalizzate definite. (UCS3.3.1.9 ) \\
...
2. Lo sviluppatore specifica i permessi delle azioni personalizzate definite. (UCS3.3.2.5) \\
...
\subsubsection{UCM - Operazioni ad alto livello - Utente MaaS non autenticato} 
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCM - Operazioni ad alto livello - Utente MaaS non autenticato.png}
...
\subsubsection{UCM - Operazioni ad alto livello - Utente MaaS autenticato} 
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCM - Operazioni ad alto livello - Utente MaaS autenticato.png}
...
\subsubsection{UCM1 - Registrazione} 
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCM1 - Registrazione.png}
...
La password dovrà essere alfanumerica e di 8 caratteri minimo. \\ 
...
\subsubsection{UCM4 - Login} 
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCM4 - Login.png}
      \caption{UCM4 - Login}
      \end{center} 
    \end{figure}  
...
\subsubsection{UCM6 - Modifica profilo} 
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCM6 - Modifica profilo.png}
...
\subsubsection{UCM7 - Eliminazione account} 
      ...
      \textbf{Attori Primari} & Utente MaaS Autenticato \\ 
          ...
          \textbf{Flusso Principale} & 1. L'utente elimina il proprio account dal sistema (UCM7). \\
           \textbf{Inclusioni} & UCM9 - Eliminazione namespace utente;
UCM10 - Eliminazione Collection utente; \\
      \end{longtable}
      \egroup
\end{center}
...
\subsubsection{UCM8 - Gestione file di configurazione} 
    \begin{figure}[H]
      \begin{center}
      \includegraphics[width=12cm]{UML/UCM8 - Gestione file di configurazione.png}
...
\subsubsection{UCM9 - Eliminazione namespace utente} 
      %Tabella 
      \begin{center}
      \bgroup
      \def\arraystretch{1.8}     
      ...
      \hline
      \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UCM9 - Eliminazione namespace utente}} \\ 
      \hline
      
      \textbf{Attori Primari} & Sviluppatore MaaS autenticato \\ 
          \textbf{Scopo e Descrizione} & Una volta che l'utente \glossario{MaaS} elimina il proprio profilo viene automaticamente eliminato il \glossario{namespace} ad esso associato, in modo da non lasciare \glossario{garbage} nel sistema. \\ 
          
          \textbf{Precondizioni}  & L'utente \glossario{MaaS} ha eliminato il proprio profilo.\\ 
          
          \textbf{Postcondizioni} & Il sistema \glossario{MaaS} ha eliminato il \glossario{namespace} associato all'utente eliminato. \\
      \end{longtable}
      \egroup
\end{center}

\subsubsection{UCM10 - Eliminazione Collection utente} 
      %Tabella 
      \begin{center}
      \bgroup
      \def\arraystretch{1.8}     
      ...
      \hline
      \multicolumn{2}{ | c | }{ \cellcolor[gray]{0.9} \textbf{UCM10 - Eliminazione Collection utente}} \\ 
      \hline
      
      \textbf{Attori Primari} & Sviluppatore MaaS autenticato \\ 
          \textbf{Scopo e Descrizione} & Una volta che l'utente \glossario{MaaS} elimina il proprio profilo vengono automaticamente eliminate le \glossario{Collection} ad esso associato, in modo da non lasciare \glossario{garbage} nel sistema. \\ 
          
          \textbf{Precondizioni}  & L'utente \glossario{MaaS} ha eliminato il proprio profilo.\\ 
          
          \textbf{Postcondizioni} & Il sistema \glossario{MaaS} ha eliminato le \glossario{Collection} associate all'utente eliminato. \\
      \end{longtable}
      \egroup
\end{center}
