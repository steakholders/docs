...
Sebbene inizialmente sviluppata per applicazioni desktop, \glossario{MVC} è stato usato moltissimo come architettura per le Web applications in tutti i principali linguaggi di programmazione. Moltissimi \glossario{framework} commerciali e non sono stati progettati utilizzando questo pattern.
