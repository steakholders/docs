...
\subsection{Specifica componente Back-end::DeveloperProject}

\subsubsection{Specifica classe ProjectConfig}
...
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Config}
\end{itemize}
...
\subsubsection{Specifica classe ProjectApp}
...
\begin{itemize}
\item[$\cdot$] \class{Back-end::DeveloperProject::Config::ProjectConfig}
\item[$\cdot$] \class{Back-end::Lib::ServerApp}
\end{itemize}
\end{itemize}
...
\subsection{Specifica componente Back-end::Lib}

\subsubsection{Specifica classe ServerApp}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Controller::Middleware::MiddlewareLoader}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe Config}
...
\subsection{Specifica componente Back-end::Lib::View}

\subsubsection{Specifica classe ForgotMailView}
...
\subsection{Specifica componente Back-end::Lib::Controller}

\subsection{Specifica componente Back-end::Lib::Controller::Middleware}

\subsubsection{Specifica classe Authentication}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::UserModel}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe MiddlewareLoader}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Controller::Middleware::DSLLoaderHandler}
\item[$\cdot$] \class{Back-end::Lib::Controller::Middleware::NotFoundHandler}
\item[$\cdot$] \class{Back-end::Lib::Controller::Middleware::ErrorHandler}
\item[$\cdot$] \class{Back-end::Lib::Utils::Mailer}
\item[$\cdot$] \class{Back-end::Lib::Controller::Middleware::Router}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe DSLLoaderHandler}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::DSLDomain}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe NotFoundHandler}
...
\subsubsection{Specifica classe ErrorHandler}
...
\subsubsection{Specifica classe Router}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Controller::Middleware::Authentication}
\item[$\cdot$] \class{Back-end::Lib::Controller::Controller::ControllerFactory}
\item[$\cdot$] \class{Back-end::Lib::Utils::MaapError}
\end{itemize}
\end{itemize}
...
\subsection{Specifica componente Back-end::Lib::Controller::Controller}
...
\subsubsection{Specifica classe IndexController}
...
\subsubsection{Specifica classe ControllerFactory}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Controller::Controller::UserController}
\item[$\cdot$] \class{Back-end::Lib::Controller::Controller::IndexController}
\item[$\cdot$] \class{Back-end::Lib::Controller::Controller::ShowController}
\item[$\cdot$] \class{Back-end::Lib::Controller::Controller::ProfileController}
\item[$\cdot$] \class{Back-end::Lib::Controller::Controller::ForgotController}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe ShowController}
...
\subsubsection{Specifica classe ForgotController}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::View::ForgotMailView}
\end{itemize}
\end{itemize}
...
\subsection{Specifica componente Back-end::Lib::Model}
...
\end{itemize}
\item[] \method{+\underline{updateLevel}(errback:function(MaapError), userId:String, newLevel:String, callback:function(String))} \\ Questo metodo modifica il livello di un utente presente nel database delle credenziali utente.
\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
...
\subsection{Specifica componente Back-end::Lib::Model::DSLModel}

\subsubsection{Specifica classe DSLDomain}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::DSLInterpreterStrategy}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::DSLCollectionModel}
\end{itemize}
\end{itemize}
...
\end{itemize}
\item[] \method{+registerCollection(name:String, model:DslCollectionModel, callback:function(String), errback:function(MaapError))} \\ Questo metodo si occupa di inserire nel registro delle \glossario{DSLCollectionModel} un nuovo modello.
\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
...
\item[$\circ$] \parameter{callback:function(String)} \\ Questa funzione viene chiamata alla fine del metodo per segnalare tramite un messaggio che il metodo è stato eseguito correttamente.
\item[$\circ$] \parameter{errback:function(MaapError)} \\ Questa callback viene chiamata nel caso in cui il metodo non sia stato eseguito correttamente e abbia generato degli errori o sollevato eccezioni. La callback prende in input l'errore generato.
\end{itemize}
...
\subsubsection{Specifica classe DSLInterpreterStrategy}
...
\item[] È estesa dalle classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::DSLInterpreterStrategy::ConcreteDSLInterpreter}
\end{itemize}
...
\subsubsection{Specifica classe DSLCollectionModel}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::IndexModel}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::ShowModel}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe IndexModel}
...
\subsubsection{Specifica classe ConcreteDSLInterpreter}
...
\subsubsection{Specifica classe ShowModel}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::Attribute}
\end{itemize}
\end{itemize}
...
\subsubsection{Specifica classe Trasform}
...
\subsubsection{Specifica classe Attribute}
...
\item[] Utilizza le classi:
\begin{itemize}
\item[$\cdot$] \class{Back-end::Lib::Model::DSLModel::Trasform}
\end{itemize}
\end{itemize}
...
\subsection{Specifica componente Back-end::Lib::Utils}

\subsubsection{Specifica classe Mailer}
...
\paragraph*{Metodi}
\begin{itemize}
\item[] \method{+init(app:ServerApp)} \\ Metodo che crea il servizio email e rende disponibile l'invio di email tramite \code{sendEmail()}.
\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
\item[$\circ$] \parameter{app:ServerApp} \\ È l'istanza del server dell'applicazione.
\end{itemize}
\item[] \method{+sendEmail(errback:function(MaapError), message:Object, callback:function(responseStatus))} \\ Metodo che si occupa di inviare un'email.
\begin{itemize}\addtolength{\itemsep}{-0.5\baselineskip}
...
\subsubsection{Specifica classe MaapError}
