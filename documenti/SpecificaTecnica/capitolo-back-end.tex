...
\begin{figure}[H]
\centering
%TODO \includegraphics[width=\textwidth]{uml/Back-end-Diagramma dei Packages.png}
...
\begin{figure}[H]
\centering
%TODO \includegraphics[width=\textwidth]{uml/Back-end-Diagramma delle classi.png}
\caption{Diagramma delle classi del Back-end}
\label{diagrammaClassiBackEnd}
\end{figure}

%\import{back-end-packages} Contiene "Descrizione componenti Back-end"

%\subsection{Oggetti dopo l'inizializzazione} %TODO
%Descrizione 
...
Nell'opzione che i paramentri passati per la modifica del profilo siano errati, \emph{editProfile} chiamarà la callback passandogli la descrizione dell'errore come parametro che il router andrà a gestire.
\begin{figure}[H]
	\begin{center} 
...
Nell'opzione che i parametri passati per la modifica del \glossario{Document} siano errati, il controller chiamerà la callback passandole l'errore che il router dovrà gestire.
\begin{figure}[H]
	\begin{center} 
...
Il controller \emph{collectionAction} si occupa di eseguire i controlli sugli attributi passatogli corrispondenti all'azione da eseguire e alla \glossario{Collection} sulla quale tale azione deve essere gestita, in caso siano errati chiamerà una next(error).
\begin{figure}[H]
	\begin{center} 
...
Nell'opzione i parametri siano errati, \emph{documentAction} chiamarà la callback passandogli la descrizione dell'errore come parametro.
\begin{figure}[H]
	\begin{center} 
