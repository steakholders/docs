...
\begin{itemize}
\item[] \code{\textbf{columnLabel}} corrisponde al nome viasualizzato nell'intestazione della colonna;
...
I parametri acettati dalla configurazione di una column di una index-page sono i seguenti: 
\begin{itemize}
\item[] \code{\textbf{rowLabel}} corrisponde al nome viasualizzato nell'intestazione della riga;
